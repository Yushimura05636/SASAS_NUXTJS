      ...
      <main class="p-4 sm:p-6 bg-gray-100 min-h-screen">
        ...
        <section class="mb-6">
          <h1 class="text-xl sm:text-2xl font-semibold">
            Welcome, <span class="font-bold text-gray-700">Cashier</span>
          </h1>
...
{ name: "Insert Payment", href: "/", icon: ChartPieIcon, current: false },

// { name: "Insert Payment", icon: UsersIcon, current: false,
//     children: [
//         { name: "Generate Payment Receipt", href: "/#", icon: UserIcon, current: false },
