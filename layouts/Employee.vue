      ...
      <main class="p-4 sm:p-6 bg-gray-100 min-h-screen">
        ...
        <section class="mb-6">
          <h1 class="text-xl sm:text-2xl font-semibold">
            Welcome, <span class="font-bold text-gray-700">Employee</span>
          </h1>
...
{ name: "Loan Application", icon: UsersIcon, current: false,
    children: [
...
{ name: "Customer Creation", icon: UsersIcon, current: false,
    children: [
        { name: "", href: "/#", icon: UserIcon, current: false },
        { name: "", href: "/#", icon: UserIcon, current: false },
        { name: "", href: "/#", icon: InboxIcon, current: false },
...
{ name: "Customer Verification", icon: UsersIcon, current: false,
    children: [
        { name: "", href: "/#", icon: UserIcon, current: false },
        { name: "", href: "/#", icon: UserIcon, current: false },
        { name: "", href: "/#", icon: InboxIcon, current: false },
